      ...
      <footer className="block">
        <div className="flex flex-wrap my-auto gap-x-6 gap-y-8">
          ...
          <div className="flex grow space-between flex-wrap items-start">
            <ul className="min-w-[160px]">
              <li className="mb-2 max-w-[180px]">
                <a
                  ...
                  className="text-lg leading-[1.22] color-[rgba(0, 0, 0, 0.48)]">
                  Συμπέρασμα
                </a>
              </li>
              <li className="mb-2 max-w-[180px]">
            ...
            <select
              id="language-picker"
              className="footer-links__language footer-link language-select text-lg leading-[1.22] color-[rgba(0, 0, 0, 0.48)]"
              name="countries">
              <option
